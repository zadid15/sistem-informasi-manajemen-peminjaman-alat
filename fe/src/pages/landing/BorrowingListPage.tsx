...
export default function BorrowingListPage() {
    ...
    return (
        <div className="bg-white">
            {/* Header — selalu tampil, statis */}
            <section className="pt-52 px-6 lg:px-8 bg-gradient-to-b from-gray-50/50 to-white">
            ...
            <div className="max-w-7xl mx-auto mt-6 overflow-x-auto rounded-xl bg-gray-50 shadow-sm mb-[80px]">
                <table className="w-full text-sm border-separate border-spacing-0 rounded-xl">
                    {/* Table head — selalu tampil, statis */}
                    ...
                    {/* tbody — skeleton kalau loading, data kalau sudah ada */}
                    <tbody>
                        {loading ? (
                            ...
                            <tr className="bg-white">
                                <td colSpan={5} className="py-12 px-6">
                                    <EmptyState
                                        ...
                                        description="Coba ubah filter atau lakukan peminjaman baru"
                                    />
                                </td>
                            </tr>
                        ) : (
                ...
                {/* Pagination — skeleton kalau loading, real pagination kalau sudah ada */}
                {loading ? (
                    <PaginationSkeleton />
                ) : meta && (
